...
1997) is three conditions under which the nuisance becomes \emph{eliminable}, so
...
Gill, van der Laan and Robins setting, the home of semiparametric efficiency and
targeted learning. The missing paper develops the influence-function, efficient-score
...
(Manski or Tamer style) or higher-order expansions, so the partial-identification
...
model and connecting to the coarse-label learnability line (Fotakis et al. 2021; the
2026 mean-estimation-from-coarse-data work).
